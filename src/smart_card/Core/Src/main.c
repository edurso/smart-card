...
int main(void) {
    ...
    BSP_LCD_DisplayStringAt(BSP_LCD_GetYSize() - boxsize * 1.25, boxsize / 2 - BSP_LCD_GetFont()->Height / 2,
                            (uint8_t*)"MY INFO", CENTER_MODE);
    BSP_LCD_DrawRect(BSP_LCD_GetXSize() - boxsize, boxsize, boxsize, boxsize);
    BSP_LCD_DisplayStringAt(BSP_LCD_GetYSize() - boxsize * 1.25, boxsize + boxsize / 2 - BSP_LCD_GetFont()->Height / 2,
                            (uint8_t*)"NEXT", CENTER_MODE);
    BSP_LCD_DrawRect(BSP_LCD_GetXSize() - boxsize, boxsize * 2, boxsize, boxsize);
    BSP_LCD_DisplayStringAt(BSP_LCD_GetYSize() - boxsize * 1.25,
                            boxsize * 2 + boxsize / 2 - BSP_LCD_GetFont()->Height / 2, (uint8_t*)"PREVIOUS",
                            CENTER_MODE);
