...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOF, LCD_CS_Pin|TS_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, LCD_RST_Pin|LCD_BL_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : LCD_CS_Pin TS_CS_Pin */
  GPIO_InitStruct.Pin = LCD_CS_Pin|TS_CS_Pin;
